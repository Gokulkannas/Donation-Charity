...
exports.agent_previous = async (req,res)=>{
    try
	{
		...
		res.render("./transport_nav/pre_navbar", { title: "Previous Collections", previousCollections });
	}
	catch(err)
	{
		console.log(err);
...
exports.agent_dash = async (req,res)=>{
	...
	res.render("./transport_nav/dash_navbar", {
		title: "Dashboard",
...
exports.agent_pending = async (req,res)=>{
    try
	{
		...
		res.render("./transport_nav/pending_nav", { title: "Pending Collections", pendingCollections });
	}
	catch(err)
	{
		console.log(err);
...
exports.view_collect = async (req,res)=>{
    try
	{
		...
		res.render("./transport_nav/view_collect_nav", { collection });
	}
	catch(err)
	{
		console.log(err);
...
exports.collect = async (req,res)=>{
	try
	{
		...
		res.redirect(`/transviewcollect/${collectionId}`);
	}
	catch(err)
	{
		console.log(err);
...
exports.agent_profile = async (req,res)=>{
    return res.render("./transport_nav/profile_nav")
}
exports.edit_agent = async (req,res)=>{
    return res.render("./transport_nav/edit_nav")
}